...
convert_all_characters($dictionaries);
...
function convert_single_character_to_SQL($character_array) {
    ...
    $CHARACTER_SCHEMA = ['name', 'actor_name', 'faction', 'first_appearance'];
    $WIKI_KEYS = ['Portrayed by', 'First seen']; 
