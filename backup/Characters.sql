...
CREATE TABLE IF NOT EXISTS `Characters` (
  ...
  `first_appearance` varchar(30) NOT NULL,
...
('Bronn', '"Cripples, Bastards and Broken', 'Alive', 'Tyrion''s sellsword who dgaf about anything and does pretty much whatever he wants. Good at swords'),
...
('Drogo', '"Winter is Coming"', 'Deceased', 'Mongolian Dave Navarro'),
...
('Gendry', '"Cripples, Bastards and Broken', 'Alive', 'Bastard son of Robert Baratheon raised in secret as a blacksmith. Arya''s pal'),
('Gilly', '"The North Remembers', 'Alive', 'Wildling with an overbite and a heart of gold'),
('Gregor Clegane', '"Cripples, Bastards and Broken', 'Alive', 'Very large, very mean individual. Turned into some kind of undead zombie knight by Qyburn'),
...
('Ilyn', '"The Kingsroad"', 'Alive', 'Royal executioner, chops off [SPOILER] Stark''s head'),
('Jaime Lannister', '"Winter is Coming"', 'Alive', 'Cersei''s brother, father of the year, good at swords, missing a hand'),
('Janos Slynt', '"Cripples, Bastards and Broken', 'Deceased', 'Lannister lackey who gets sent to the wall, cries a lot, and then gets be[SPOILER]ed'),
...
('Samwell Tarly', '"Cripples, Bastards and Broken', 'Alive', 'Sam the Slayer, member of the Night''s Watch. Gilly''s boyfriend. Clearly just George R.R. Martin'),
...
('SUPERMAN', 'Krypton', 'Immortal', 'Guy who cannot die'),
...
('Xaro', '"Garden of Bones"', 'Deceased', 'Supposedly rich dude in Qarth who tries to woo Khaleesi but is secretly broke and tries to steal her [SPOILER] so she has him [SPOILER]ed'),
