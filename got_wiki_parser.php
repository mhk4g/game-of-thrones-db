...
$characters = [Eddard_Stark, Catelyn_Stark, Robb_Stark, Sansa_Stark, Arya_Stark, Bran_Stark, Rickon_Stark, Jon_Snow, Brynden_Tully, Edmure_Tully, Tywin_Lannister, Cersei_Lannister, Jaime_Lannister, Tyrion_Lannister, Joffrey_Baratheon, Myrcella_Baratheon, Tommen_Baratheon, Kevan_Lannister, Lancel_Lannister, Bronn, Qyburn, Small_Council, Pycelle, Petyr_Baelish, Varys, House_Tyrell, Margaery_Tyrell, Loras_Tyrell, Olenna_Tyrell, Mace_Tyrell, House_Bolton, Roose_Bolton, Ramsay_Bolton, Theon_Greyjoy, Walda_Bolton, House_Frey, Walder_Frey, Lothar_Frey, Walder_Rivers, Roslin_Frey, Robert_Baratheon, Stannis_Baratheon, Renly_Baratheon, Brienne_of_Tarth, Selyse_Baratheon, Shireen_Baratheon, Gendry, Davos_Seaworth, Salladhor_Saan, Melisandre, Daenerys_Targaryen, Viserys_Targaryen, Aerys_II_Targaryen, Rhaegar_Targaryen, Aemon, Drogo, Barristan_Selmy, Missandei, Grey_Worm, Daario_Naharis, Doran_Martell, Trystane_Martell, Elia_Martell, Oberyn_Martell, Ellaria_Sand, Sand_Snakes, Obara_Sand, Nymeria_Sand, Tyene_Sand, Areo_Hotah];
$nodeNames = ["First seen", "Also known as", "Status", "Allegiance", "Portrayed by", "Death"];
...
function get_character_info($character) {
    ...
    // this wiki sucks and some of their stuff is formatted wrong
    // valueIndex is used to fix it. See below.
    $valueIndex = 0;
